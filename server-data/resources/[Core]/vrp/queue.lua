...
Config.Language = {
	joining = "[ BaseClearVitorNasBr ] Entrando...",
	connecting = "[ BaseClearVitorNasBr ] Conectando...",
	err = "[ BaseClearVitorNasBr ] Não foi possível identificar sua Steam ou Social Club.",
	_err = "[ BaseClearVitorNasBr ] Você foi desconectado por demorar demais na fila.",
	pos = "[ BaseClearVitorNasBr ] Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "[ BaseClearVitorNasBr ] Não foi possível adiciona-lo na fila.",
    wlonly = "[ BaseClearVitorNasBr ] Você não está aprovado na whitelist.",
	banned = "[ BaseClearVitorNasBr ] Seu passaporte foi revogado na cidade.",
	steam = "[ BaseClearVitorNasBr  ] Você precisa estar com a Steam aberta para conectar."
}
