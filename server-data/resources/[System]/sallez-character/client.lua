RegisterNetEvent("sallez-character:normalSpawn")
RegisterNetEvent("sallez-character:characterCreate")
...
AddEventHandler("sallez-character:characterCreate",function()
	doStatus = 1
...
AddEventHandler("sallez-character:normalSpawn",function(firstspawn)
	if firstspawn then
...
function TriggerCreateCharacter()
	...
	SetEntityCoordsNoOffset(PlayerPedId(),-1845.88, -1229.18, 13.04,true,true,true) 
...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	TriggerServerEvent("sallez-character:finishedCharacter", characterNome,characterSobrenome,characterAge,currentCharacterMode)
